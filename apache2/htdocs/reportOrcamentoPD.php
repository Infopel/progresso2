<?php
	...
	if(isset($_GET['id_plan'])){
		...
		while ($programa = $get_projectos->fetchObject()) {
			...
			$listProgramas .= "<tr><td>".$programa->nome_programa."</td><td><b>".number_format($orcObjectivos->orc_objectivo,2, '.', '')."</b> Meticais</td><td><b>". number_format($orcamento->total_orcamento)."</b> Meticais</td><td><b>".number_format($orcamento->valor_gasto)."</b> Meticais</td></tr>";
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a style="font-size:11px;" href="reportOrcamentoPD.php"><em class="fa fa-bar-chart">&nbsp;</em>Orçamento PDE</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h4 class="page-header">Or&ccedil;amento PDE</h4>
			</div>
		</div><!--/.row-->
	...
	<script>
		...
		var barChartData = {
			...
			datasets: [{
				label: 'Orçamento do Plano Estrategico',
		...
		window.onload = function() {
			...
			window.myBar = new Chart(ctx, {
				...
				options: {
					...
					title: {
						display: true,
						text: 'Gráfico de Barras - Orçamento PDE'
					}
				}
			});
