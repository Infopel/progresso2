    ...
    public function reportPDE($p){
		...
		$DOMHtml = "<html>
                    <head>
                        ...
                        <title>Associação PROGRESSO</title>
                    ...
                    <body>
                        <style>
                            ...
                            th { background:#a0ce4e !important; color: #383838;}
                        </style>
                        <center>
                                <h4 style='text-transform: uppercase'>Associação PROGRESSO</h4>
                                <p>Av. Ahmed Sekou Touré Nº 1957, Maputo - Phone: + 258 21 430 485/6: Email: comunicar@progresso.co.mz <br>Maputo - Mocamique </p>
		...
		$arquivo = "Actividades_PDE".$data.".xls";
	...
	public function reportOrcProj($p){
		...
		$this->DOMhtml = "
					...
					<table>
						<thead>
							<tr class='p-2 border-0' style=' font-size: 0.78rem; '>
								<th style='width:340px'>".$resp_header->res_final."</th>
								<th style='width:340px'>".$resp_header->res_intermedio."</th>
								<th>".$resp_header->res_imediato."</th>
								<th>".$resp_header->produto."</th>
								<th style='width:340px'>".$resp_header->actividade."</th>
								<th>".$resp_header->indicador."</th>
