...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
	...
	<!--<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a style="font-size:11px;" href="reportPD.php?p=12"><em class="fa fa-file">&nbsp;</em>Orçamento PDE</a></li>
			<li class="active"><a style="font-size:11px;" href="reportOrcamentoProj.php?p="><em class="fa fa-file">&nbsp;</em>Orçamento Projectos</a></li>
		</ul>
	</div><!--/.sidebar-->
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				 <h4>Or&ccedil;amento Projectos (<?php $row=mysqli_fetch_assoc($results2); echo ($row['name'])?>)</h4>
			</div>
		</div><!--/.row-->
  ...
  <br/><br/>
   <form action="#">
							<div class="form-group">
								...
								<p></p>
								<button type="submit" class="btn btn-success">Gerar Graficos</button><br/>
								<input type="button" onclick="window.print()" class="btn btn-success" value="Imprimir" style="background-color:green;color:white;float:right;"/>
							</div>
						</form>
<table border="1" width="100%">
	...
	<tr>
			...
			<th style="font-size:10px;">Orcamento (MZN)</th>
			<th style="font-size:10px;">Valor Gasto (MZN)</th>
...
<tr>
  ...
  <td style="font-size:8px;"><?= ($row['orcamento'])?></td>
  <td style="font-size:8px;"><?= ($row['valorGasto'])?></td>
  <td style="font-size:8px;"><?= (floatval(($row['valorGasto'])) / floatval(($row['orcamento'])))*100?></td>
