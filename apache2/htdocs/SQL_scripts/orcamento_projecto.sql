SELECT DISTINCT i.id, i.subject AS actividade, t.name AS name, ind.subject AS indicador, prod.subject AS produto,
	...
	WHERE i.tracker_id = 11 AND i.project_id=17 Order by t.position ASC;