...
<li><a href="reportBeneficiariosProj.php"><em class="fa fa-bar-chart">&nbsp;</em>Beneficiários Projecto</a></li>
			<li class="active"><a href="reportPProv.php"><em class="fa fa-bar-chart">&nbsp;</em>Projectos por Provincia</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Relatório de projectos por provincia</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
					<div class="col-md-3" style="max-width:370px; min-width: 370px;">
						<div>
			                ...
			                <map name="mocambique" id="mocambique">
			                                ...
			                                <a href="?provincia=Maputo-Cidade" itemid="1">
			                                ...
			                                <a href="?provincia=Maputo-Província" itemid="2">
			                                ...
			                                <a href="?provincia=Gaza" itemid="3">
			                                ...
			                                <a href="?provincia=Inhambane" itemid="4">
			                                ...
			                                <a href="?provincia=Manica" itemid="5">
			                                ...
			                                <a href="?provincia=Sofala" itemid="6">
			                                ...
			                                <a href="?provincia=Tete" itemid="7">
			                                ...
			                                <a href="?provincia=Zambézia" itemid="8">
			                                ...
			                                <a href="?provincia=Nampula" itemid="9">
			                                ...
			                                <a href="?provincia=Niassa" itemid="10">
			                                ...
			                                <a href="?provincia=Cabo Delgado" itemid="11">
					...
					<div class="col-md-6" style="min-width: 350px">
						<div class=".panel .panel-default">
							<div class="panel-heading" style="margin-left: -16px; margin-bottom: -8px;"><b>Provicncia:</b> <?php echo $provincia;?></div>
							<div>
										<b><p>Numero de Projectos: </p></b>
										<b><p>Descricao dos projectos: </p></b>
										<p>stdClass::$getListaProj</p>
							</div>
						</div>
					</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-12" style="padding-left: 16px; padding-right: 16px">
					<div class=".panel .panel-default">
							<div class="panel-heading" style="margin-left: -16px;">Provicncia: <?php echo $provincia;?></div>
